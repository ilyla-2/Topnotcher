...
def main():
    ...
    if source.get("status") != "PASS":
        failures.append("v3.21.17 source/runtime interaction audit is not PASS")
    ...
    if after.get("startupUrl") != "payload/CELE_Topnotcher_OS_v3_21_0.html":
        failures.append("Release identity overlay does not directly start the reviewed CELE payload")
    ...
    report = {
        "schemaVersion": 1,
        "phase": "v3.21.18-built-windows-rc4-audit",
        "status": "PASS" if not failures else "FAIL",
        "releaseType": "UNSIGNED_RC4_NOT_FOR_PUBLIC_DISTRIBUTION",
