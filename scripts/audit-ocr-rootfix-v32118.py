...
def main():
  ...
  html=(root/"CELE_Topnotcher_OS_v3_21_0.html").read_text()
  ...
  js=(root/"assets/js/01-ocr-ui-wire-compat-v32118.js").read_text()
  for s in ["function nativeOcrCurrentScanPage","function nativeOcrAllScanPages","ocrPageV15","clampScanRangeV12"]:
