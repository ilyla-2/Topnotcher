...
def main():
    ...
    if source.get("status") != "PASS":
        failures.append("v3.21.20 source/runtime large-PDF audit is not PASS")
    ...
    report = {
        "schemaVersion": 1,
        "phase": "v3.21.20-built-windows-rc5-audit",
        "status": "PASS" if not failures else "FAIL",
        "releaseType": "UNSIGNED_RC5_NOT_FOR_PUBLIC_DISTRIBUTION",
